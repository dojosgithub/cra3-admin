...
function BuStatusView({
  ...
  const csvHeaders = [
    ...
    },
    {
      ...
      }`, // FIXME - Source Documentation, CRF, Source-to-CRF Review  => Source Data Verification (need to read domain name from db)
      key: 'training2',
    },
    {
      label: `Training - ${
  ...
  return (
    ...
    >
      ...
      <CardContent>
        <Card sx={{ p: 2, height: 'calc(100vh - 320px)', overflow: 'auto' }}>
          <Stack spacing={2}>
